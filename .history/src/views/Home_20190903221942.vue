    ...
    <div class="container">
        ...
        <div class="form-container" id="hash1">
            ...
            <div class="main-content" id="insureForm">
                <!-- <form action=""> -->
                    ...
                    <mt-field label="到达城市" 
                        placeholder="到达城市"
                        v-model="formData.endCity"
                        :disabled="isExceed ? true : false" 
                        @blur.native.capture="validateForm(10)"
                        class="endCity"></mt-field>
                    <p class="error-msg"></p>
                    ...
                    <p class="checkbox">
                        <input type="checkbox" name="protocal" id="protocal"/><i></i>
        ...
        <div class="instructions">
            ...
            <section class="ins-list">
                <ul>
                    <li><p>权益领取时间：即日起至2019年12月31日</p></li>
...
export default {
    ...
    methods: {
        ...
        validateEndCity(){
            if(this.checkRequired('endCity', '请输入到达城市')){
